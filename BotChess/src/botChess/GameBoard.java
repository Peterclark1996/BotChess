...
public class GameBoard extends JPanel{
	...
	public void paintComponent(Graphics g){
		...
		if(GameHandler.getSelectedX() >= 0 && GameHandler.getSelectedX() <= 7 && GameHandler.getSelectedY() >= 0 && GameHandler.getSelectedY() <= 7) {
			...
			Move[] possibleMoves = GameHandler.getCurrentGameThread().getCurrentGameState().getPossibleMoves(GameHandler.getCurrentGameThread().getCurrentTeamTurn(), GameHandler.getSelectedX(), GameHandler.getSelectedY(), false);
